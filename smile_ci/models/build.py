...
class Build(models.Model):
    ...
    def _get_options(self):
        ...
        return {
            ...
            'test_path': format_str(branch.test_path),
    ...
    def _send_build_result(self, short_message):
        ...
        self.message_post(body=body, subject=subject, subtype='mail.mt_comment', partner_ids=self.branch_id.message_follower_ids.ids)
